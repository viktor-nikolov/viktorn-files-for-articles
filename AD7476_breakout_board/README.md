...
I created a simple breakout board with two [AD7476](https://www.analog.com/en/products/ad7476.html) ADCs and a voltage reference. However, there is no low-pass filter or buffer op-amp. I made the board pin compatible with Digilent [Pmod AD1](https://digilent.com/reference/pmod/pmodad1/start).
...
I published KiCad 9.0 [design files](https://github.com/viktor-nikolov/viktorn-files-for-articles/blob/main/AD7476_breakout_board/AD7476_Pmod_Rev1.1_KiCad_archive.zip) in my repository, which are ready for manufacture (including assembly) at JLCPCB using JLCPCB [fabrication toolkit](https://github.com/bennymeg/Fabrication-Toolkit) KiCad plugin.
The only reasons I used AD7476 instead of [AD7476A](https://www.analog.com/en/products/ad7476a.html) (the chip Pmod AD1 uses) was the fact that AD7476 was in stock in the JLCPCB parts library at the time. The differences between AD7476 and AD7476A are small though.
