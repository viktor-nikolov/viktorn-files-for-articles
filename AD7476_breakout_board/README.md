...
- I included here a [sample project](sample_project) that digitizes one or two analog inputs using Digilent [Zybo Z7-20](https://digilent.com/reference/programmable-logic/zybo-z7/start) board and Digilent [Pmod AD1](https://digilent.com/reference/pmod/pmodad1/start) (or my AD7476 breakout board). A FreeRTOS app running on Zybo Z7 sends data samples in binary form over the network to a PC, where a [Python script](sample_project/AD7476_visualiser.py) is running. The script decodes the data and displays it in the chart. More details about the project are explained [in this readme](sample_project).
